...
<script src="{{asset('admintemplate/assets/vendors/js/vendor.bundle.base.js')}}"></script>
    ...
    <script src="{{asset('admintemplate/assets/vendors/progressbar.js/progressbar.min.js')}}"></script>
    <script src="{{asset('admintemplate/assets/vendors/jvectormap/jquery-jvectormap.min.js')}}"></script>
    <script src="{{asset('admintemplate/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('admintemplate/assets/vendors/owl-carousel-2/owl.carousel.min.js')}}"></script>
    ...
    <script src="{{asset('admintemplate/assets/js/settings.js')}}"></script>
